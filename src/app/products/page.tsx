...
export const metadata: Metadata = {
  title: 'Products',
  description:
    'Explore the Blind Teknologis platform capabilities for automotive service operations.',
  openGraph: {
        ...
        <section className="py-16 sm:py-24">
          <div className="mx-auto grid max-w-6xl gap-6 px-5 sm:grid-cols-2 sm:px-8">
            {PRODUCTS.map((product, index) => (
              <article
                key={product.title}
                className="rounded-2xl border border-zinc-200 bg-white p-8 transition-all duration-300 hover:-translate-y-1 hover:border-zinc-300 hover:shadow-xl hover:shadow-zinc-200/50"
              >
