...
import { ABOUT_STATS, SITE_NAME, SITE_URL } from '@/lib/site'

export const metadata: Metadata = {
  title: 'About',
  description:
    'Learn about Blind Teknologis and our mission to transform automotive service operations.',
  openGraph: {
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        {/* Stats */}
        <section className="bg-surface-light py-16 sm:py-20" aria-label="Company stats">
